...
export default function Step3(prop: Props) {
      ...
      <div className="fixed bottom-0 bg-white
        ...
        <div className="w-1/2">
          <p className="font-bold">{ information.type_name }:
            <span className="text-2xl font-black text-primary"> { information.date_range }</span>
          </p>
      ...
      <div className="flex justify-center mt-5 mb-5">
        <Card className="w-11/12 shadow-md border-primary shadow-primary m-0 p-8">
          <CardHeader className="p-0">
            <CardDescription className="text-lg">Step 3</CardDescription>
